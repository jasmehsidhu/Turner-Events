...
load()
   ...
   async function accept(e){
      ...
      load(true)
      var data=await axios.post('https://event-app-8.onrender.com/main',Object)
      if(data.data=='done'){
...
load(true)
var data=await axios.post('https://event-app-8.onrender.com/reject',{reason:reas,contact:contacts,key:key})
 var newarr=request.filter((ele,index)=>{
    if(ele.id!=key){
        return ele
    }
